          ...
          <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              <div class="navbar-nav ms-auto py-3">
                ...
                <a href="cadastrar.php" class="nav-item nav-link">Registrar</a>
              </div>
            </div>
          </nav>
          <!-- TÍTULO AQUI -->
            ...
            <section>
                <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="container col-lg-9">
                        <h1>Resultados da Pesquisa de Cliente</h1>
                    
                        <?php
                            require '../db/db_connect.inc.php';
                            require '../db/cliente_crud.inc.php';
                            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                // Pega o tipo de critério e o valor da pesquisa
                                $tipo_criterio = $_POST['tipo_criterio_cliente'];
                                $criterio = trim($_POST['criterio_cliente']);
                        
                                if (strlen($criterio) < 3) {
                                    echo "<p>Por favor, insira ao menos <strong>3 caracteres</strong> para realizar a pesquisa.</p>";
                                } else {
                                    // Realiza a pesquisa com base no tipo de critério escolhido
                                    $resultados = ClienteCRUD::search($criterio, $tipo_criterio);
                                    ...
                                    if (!empty($resultados)) {
                                        ...
                                        echo "<p>Nenhum cliente encontrado com o critério: <strong>" . htmlspecialchars($criterio) . "</strong>.</p>";
                                    }
                                }
                            }
                        ?>
                        ...
                        <br>
                        <a class="btn btn-warning py-md-3 px-md-5 me-3" href="pesquisar.php">

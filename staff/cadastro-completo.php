      ...
      <div class="container-fluid bg-dark py-3 bg-header" style="margin-bottom: 90px; user-select:none;">
        <div class="row py-5">
          <div class="col-12 pt-lg-5 mt-lg-5 text-center">
            <h2 class="display-4 text-white animated zoomIn">Resultado do Cadastro</h2>
            ...
            <div class="container col-lg-9"> 
                <?php
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                        // Captura e sanitização dos dados enviados pelo formulário
                        ...
                        if (empty($nome) || empty($email) || empty($senha) || empty($confirmar_senha)) {
                            ...
                            $resultado = FuncionarioCRUD::cadastrarFuncionario($nome, $email, $senha);
                ...
                <br>
                <a class="btn btn-warning py-md-3 px-md-5 me-3" href="cadastrar.php">

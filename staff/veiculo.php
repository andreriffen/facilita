        ...
        <section>
            <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
                <div class="container col-lg-9">
                    <h1>Resultados da Pesquisa de Veículo</h1>
                    ...
                    require '../domain/entities.inc.php';
                     ...
                     if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                            // Captura o valor da placa enviada pelo formulário
                            $placa = $_POST['placa'];
                    
                            // Chama o método de pesquisa por placa
                            $resultados = VeiculoCRUD::searchByPlaca($placa);
                        } else {
                            $placa = '';
                            $resultados = [];
                        }
                        ...
                        echo "<p>Foram encontrados <strong>" . count($resultados) . "</strong> veículos(s) com a placa: <strong>" . htmlspecialchars($placa) . "</strong>.</p>";
                        ...
                        echo "<p>Nenhum veículo encontrado com o critério: <strong>" . htmlspecialchars($placa) . "</strong>.</p>";
                        }
                    ?>
                    <br>

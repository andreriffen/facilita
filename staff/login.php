      ...
      <section>
        <div class="container-fluid wow fadeInUp" data-wow-delay="0.1s">
          <div class="container col-lg-9">
            ...
            <form class="form-control p-5" action="post-login.php" method="POST">
                ...
                <?php
                    ...
                    if (isset($_SESSION['erro'])) {
                        ...
                        // Limpar o erro após exibição
                        unset($_SESSION['erro']);
                    }
                ?>
                <br><br>
                <button class="btn btn-warning py-md-3 px-md-5 me-3" type="submit"><i class="bi bi-key-fill"></i>
                    Entrar
                </button>
